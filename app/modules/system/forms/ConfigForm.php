...
namespace ZCMS\Modules\System\Forms;
...
class ConfigForm extends ZForm
{
    ...
    public function initialize($data = null)
    {
        ...
        ZTranslate::getInstance('admin')->addTemplateLang(get_child_folder(ROOT_PATH . '/app/templates/backend'));
        ZTranslate::getInstance('frontend')->addTemplateLang(get_child_folder(ROOT_PATH . '/app/templates/frontend'), 'frontend');
