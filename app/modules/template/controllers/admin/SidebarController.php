...
class SidebarController extends ZAdminController
{
    ...
    public function indexAction()
    {
        ...
        ZTranslate::getInstance(ZCMS_APPLICATION_LOCATION)->addTemplateLang($defaultTemplate, 'frontend');
        ...
        foreach ($sidebars as $index => $sidebar) {
            if ($index == 0) {
                ...
                $sidebar_html .= '<div class="col-md-6 col-sidebar-first">';
            }
            if ($index == 0) {
            ...
            if ($index == $half - 1) {
                ...
                $sidebar_html .= '</div><div class="col-md-6 col-sidebar-last">';
            }
