    ...
    <div class="login-box-body">
        ...
        <p class="text-center">
            ...
            <a href="{{ _baseUri }}" class="text-center">&larr; {{ __('m_user_help_text_back_to_frontend') }}</a> | <a
                    href="{{ _baseUri }}/admin/user/login/">{{ __('m_user_help_text_login_my_account') }}</a>
        </p>
    </div>
...
<!-- iCheck -->
<script src="{{ _baseUri }}/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
</body>
</html>